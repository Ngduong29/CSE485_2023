...
<body>
    ...
    <main class="container mt-5">
        ...
        include 'config.php';
        $id = $_GET['id'];
        $sql = "SELECT  baiviet.tieude as tieude, baiviet.ten_bhat as ten_bhat, theloai.ten_tloai as ten_tloai, baiviet.tomtat as tomtat,
        baiviet.noidung as noidung, tacgia.ten_tgia as ten_tgia, baiviet.hinhanh as hinhanh FROM baiviet, tacgia, theloai
        WHERE baiviet.ma_tloai = theloai.ma_tloai and baiviet.ma_tgia = tacgia.ma_tgia and baiviet.ma_bviet = '$id'";
        $result = mysqli_query($conn, $sql);
        $row = mysqli_fetch_assoc($result); {
            ?>
            <div class="row mb-5">
                <div class="col-sm-4">
                    <img src="/btth01/images/songs/<?= $row['hinhanh'] ?>" class="img-fluid" alt="...">
                </div>
                <div class="col-sm-8">
